...
import { AwsGithubAuthenticator } from 'netlify-cms-lib-auth';
...
export default class GitHubAuthenticationPage extends React.Component {
  ...
  handleLogin = e => {
    e.preventDefault();
    console.log("aws authentication page handle login");
    const cfg = {
    ...
    const auth = new AwsGithubAuthenticator(cfg);
